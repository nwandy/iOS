...
class TemplateViewController: UIViewController, SlideMenuDelegate {
...
//        arrayMenuOptions.append(["title":"Contatti"])
    ...
    func addSlideMenuButton(){
        ...
        btnShowMenu.addTarget(self, action: #selector(TemplateViewController.onSlideMenuButtonPressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
